...
const command = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName('prompt').setDescription('What would you like to ask?').setRequired(true)),
    async execute(interaction) {
        ...
        try {
            ...
            const message = 'I could not reach Gemini. Please verify that the API key is set and that your request is valid.';
            try {
