...
async function resolveTenorMedia(url: URL): Promise<ResolvedMediaSource | null> {
...
function resolveGiphyMedia(url: URL): ResolvedMediaSource | null {
...
export async function resolveExternalMediaSource(rawUrl: string): Promise<ResolvedMediaSource> {
  let parsed: URL;
  try {
