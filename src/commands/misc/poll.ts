...
import type { Message, PermissionName } from 'oceanic.js';

const emojis = ['1️⃣', '2️⃣', '3️⃣', '4️⃣', '5️⃣'];
const requiredPermissions: PermissionName[] = ['ADD_REACTIONS', 'READ_MESSAGE_HISTORY'];

function formatPermissionName(permission: PermissionName): string {
  return permission
    .split('_')
...
function formatPermissionList(permissions: PermissionName[]): string {
