      ...
      sub
        ...
        .addStringOption((option) =>
          option
            ...
            .setRequired(true)
            .addChoices(
              { name: 'Celsius to Fahrenheit', value: 'c_to_f' },
              { name: 'Fahrenheit to Celsius', value: 'f_to_c' }
            )
        )
    )
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((option) =>
          option
            ...
            .setRequired(true)
            .addChoices(
              { name: 'Kilometers to miles', value: 'km_to_mi' },
              { name: 'Miles to kilometers', value: 'mi_to_km' }
            )
        )
    ),
